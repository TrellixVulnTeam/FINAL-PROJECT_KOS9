...
function Textarea(_ref) {
  var active = _ref.active,
      ...
      inline = _ref.inline,
      size = _ref.size,
      props = _objectWithoutProperties(_ref, ["active", "className", "color", "fixed", "focused", "fullwidth", "hovered", "inline", "size"]);
  ...
  var classes = (0, _classnames["default"])('textarea', className, isColor, isSize, {
